...
assert.match(indexSource, /styles\.css\?v=20260828\.4/);
assert.match(indexSource, /app\.js\?v=20260828\.4/);
assert.match(indexSource, /candidate-portal\.js\?v=20260828\.4/);
assert.match(indexSource, /assessment-engine\.js\?v=20260828\.4/);
assert.match(indexSource, /ai-assessment\.js\?v=20260828\.4/);
assert.match(indexSource, /pdf-report\.js\?v=20260828\.4/);
