...
// ensureDefaultMessageTemplates() … updateMessageTemplate() live in packages/runtime/src/templates.js (concatenated at build).
...
// emailConfig() … normalizeContactPhone() live in packages/runtime/src/messaging.js (concatenated at build).
// aiConfig() … isRetryableAiError() live in packages/runtime/src/ai.js (concatenated at build).
...
// sendBrevoApi() … sendBrevo() live in packages/runtime/src/messaging.js (concatenated at build).
...
// brevoWebhookPayload() … brevoBlockedRecipient() live in packages/runtime/src/messaging.js (concatenated at build).
...
// createCandidatePortalLink() lives in packages/runtime/src/portal.js (concatenated at build). Table: candidate_portal_links.
...
// isRetryableProviderError() lives in packages/runtime/src/messaging.js (concatenated at build).
...
// batchDeliveryStatus() lives in packages/runtime/src/messaging.js (concatenated at build).
...
// normalizedJourneySteps() … processDueJourneyEvents() live in packages/runtime/src/journeys.js (concatenated at build).
...
// normalizedBrevoEvent() … brevoDeliverySummary() live in packages/runtime/src/messaging.js (concatenated at build).
...
// handleBrevoWebhook() … handleInfobipWebhook() live in packages/runtime/src/webhooks.js (concatenated at build).
