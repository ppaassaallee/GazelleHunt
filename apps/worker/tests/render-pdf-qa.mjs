...
const report = {
  ...
  aiAnalysis: { status: 'completed', provider: 'OpenAI', model: 'gpt-4.1-mini', prompt_version: 'analysis-v2.2.0', evidence_hash: 'a'.repeat(64), output_hash: 'b'.repeat(64), output: { en: localized, es: localized } },
