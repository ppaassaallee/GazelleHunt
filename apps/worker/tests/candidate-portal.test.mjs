...
const source = fs.readFileSync(new URL('../src/legacy/candidate-portal.js', import.meta.url), 'utf8');
const serverSource = fs.readFileSync(new URL('../src/legacy/server-worker.js', import.meta.url), 'utf8');
const stylesSource = fs.readFileSync(new URL('../src/legacy/styles.css', import.meta.url), 'utf8');
